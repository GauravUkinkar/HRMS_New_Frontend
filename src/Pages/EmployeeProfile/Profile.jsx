...
const Profile = () => {
  ...
  const getEmployee = async () => {
    ...
    try {
      ...
      const role = String(user?.role || user?.crmRole || "")
        .trim()
        .toUpperCase();
        ...
        <div className="bottom-side">
          ...
          <div className="left-side">
            <div className="img-group">
              ...
              <div className="btn-group">
                ...
                <div
                  className={`status ${
                    employeeprofile?.employeeStatus?.toLowerCase() !== "active"
                      ? "inactive"
                      : ""
                  }`}
                >
            ...
            <div className="status-content">
              ...
              <div className="row-one">
                ...
                <p className="value">{employeeprofile?.companyName || "N/A"}</p>
              </div>
              ...
              <div className="row-one">
                ...
                <p className="value">{employeeprofile?.department || "N/A"}</p>
              </div>
              ...
              <div className="row-one">
                ...
                <p className="value">{employeeprofile?.dateOfBirth || "N/A"}</p>
              </div>

              <div className="row-one">
                <p className="label">Gender</p>
                <span>:</span>
                <p className="value">{employeeprofile?.gender || "N/A"}</p>
              </div>
              <div className="row-one">
          ...
          <div className="right-side">
            ...
            <div className="personal-details">
              ...
              {/* AADHAAR */}
              <div className="row-one">
                <p className="label">Aadhaar Card Number</p>
              ...
              {/* UAN Number */}
              <div className="row-one">
                <p className="label">UAN Number</p>
            ...
            <div className="emergency-details">
              <div className="heading">Emergency Contact Details</div>
            ...
            <div className="salary-details">
              <div className="heading">Bank, Salary & Policy Details</div>
              ...
              <div className="row-one">
                ...
                <p className="value">{employeeprofile?.bankName || "N/A"}</p>
              </div>

              <div className="row-one">
                <p className="label">Bank IFSC Code</p>

                <span className="coma">:</span>

                <p className="value">{employeeprofile?.ifscCode || "N/A"}</p>
              </div>
              ...
              <div className="row-one">
                <p className="label">Monthly Salary</p>
              ...
              <div className="row-one">
                <p className="label">Yearly Package</p>
              ...
              <div className="row-one">
                <p className="label">Policy Number</p>
              ...
              {/* ESIC NUMBER */}
              <div className="row-one">
                <p className="label">ESIC Number</p>
